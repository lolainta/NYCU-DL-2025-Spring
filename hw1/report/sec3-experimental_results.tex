...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/hidden_16_lr_0.05_epochs_2000_BCELoss_linear/final.png}
        \caption{Dataset: Linear (Accuracy: 100\%)}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/hidden_16_lr_0.05_epochs_2000_BCELoss_xor/final.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/hidden_16_lr_0.05_epochs_2000_BCELoss_linear/loss.png}
        \caption{Dataset: Linear}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../results/hidden_16_lr_0.05_epochs_2000_BCELoss_xor/loss.png}
        \caption{Dataset: XOR}
    \end{subfigure}
